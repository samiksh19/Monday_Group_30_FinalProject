...
public class ViewOrderDetails extends javax.swing.JPanel {
    ...
    UserAccount account;
    public ViewOrderDetails(JPanel userProcessContainer,Business business, UserAccount account) {
        initComponents();
    ...
    private void fillClaimRequestTable(){
        ...
        model.setRowCount(0);
        workRequestList = business.getWorkQueue().getWorkRequestListInsurance(account);
                ...
                if (selectedRow >= 0) {
                    ...
                    if (request instanceof InsuranceWorkRequest) {
                        ...
                        if (orderWorkRequest != null) {
                           AcceptOrderPanel acceptOrderOrNotJPanel = new AcceptOrderPanel(userProcessContainer,business,account,orderWorkRequest);
    ...
    private void btnbackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbackActionPerformed
        ...
        InsuranceAdmin adminWorkAreaJPanel = new InsuranceAdmin(userProcessContainer,account, business);
