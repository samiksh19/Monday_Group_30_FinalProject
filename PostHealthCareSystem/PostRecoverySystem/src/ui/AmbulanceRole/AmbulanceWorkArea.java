...
public class AmbulanceWorkArea extends javax.swing.JPanel {
     ...
     */
    public AmbulanceWorkArea(JPanel userProcessContainer, UserAccount userAccount, Business business) {
        initComponents();
    ...
    private void fillDelRqTable(){
        ...
        model.setRowCount(0);
        workRequestList = business.getWorkQueue().getWorkRequestListAmbulanceDriver(userAccount);
                ...
                if (selectedRow >= 0) {
                    ...
                    if (request instanceof LabWorkRequest) {
                        ...
                        if (orderWorkRequest != null) {
                           ProcessAmbulanceRequests processOrderJPanel = new ProcessAmbulanceRequests(userProcessContainer,business,userAccount,orderWorkRequest);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 818, Short.MAX_VALUE))
                .addGap(37, 37, 37))
        );
