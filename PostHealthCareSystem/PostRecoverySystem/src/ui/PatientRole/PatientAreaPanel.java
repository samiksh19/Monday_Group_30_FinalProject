...
public class PatientAreaPanel extends javax.swing.JPanel {
    ...
    private void OrderIssue() {
        AppointmentSchedule placeOrderJPanel = new AppointmentSchedule(userProcessContainer, userAccount, business);
    ...
    private void OrderInfoAndFeedback() {
        AppointmentInfo orderStatusJPanel = new AppointmentInfo(userProcessContainer, business, userAccount);
    ...
    private void MedicineOrderIssue(){
        ...
        MedicineOrder medicineOrderJPanel = new MedicineOrder(userProcessContainer, userAccount, business);
        userProcessContainer.add("MedicineOrder", medicineOrderJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }
    private void emergencyRequest() {
        EmergencyRequest emergencyRequestJPanel = new EmergencyRequest(userProcessContainer, userAccount, business);
        userProcessContainer.add("EmergencyRequest", emergencyRequestJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }
    private void doctorInfo() {
        DoctorInfo doctorInfo = new DoctorInfo(userProcessContainer, userAccount, business);
    ...
    private void insuranceForm(){
        InsuranceClaimApprovalForm approvalForm = new InsuranceClaimApprovalForm(userProcessContainer, userAccount, business);
    ...
    private void initComponents() {
        ...
        btnorderInfoAndFeedback.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnorderInfoAndFeedbackinsuranceClaimApprovalbtnActionPerformed(evt);
            }
        });
    ...
    private void btnorderInfoAndFeedbackinsuranceClaimApprovalbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnorderInfoAndFeedbackinsuranceClaimApprovalbtnActionPerformed
        // TODO add your handling code here:
        insuranceForm();
    }//GEN-LAST:event_btnorderInfoAndFeedbackinsuranceClaimApprovalbtnActionPerformed
